...
//        if (payloadLen > 0 && session.state == TcpSession.State.ESTABLISHED) {
        ...
        if (payloadLen > 0
             ...
             * configured.
             */
            String requestHostname = AppOpenRequestHostnameUtils.extractHostname(data, payloadLen);
            String normalizedRequestHostname = AppOpenRequestHostnameUtils.normalizeHostname(requestHostname);
            String normalizedTargetHostname = AppOpenRequestHostnameUtils.normalizeHostname(targetHostname);
...
//                    globalRequestSentTime = 0L;
    ...
    void setTargetHostname(String hostname) {
        ...
        this.targetHostname = AppOpenRequestHostnameUtils.normalizeHostname(hostname);
...
//                );
    ...
    static class TcpSession {
        ...
        void startRealSocketReaderThread(AppOpenTcpForwarder forwarder, String key) {
...
//                        } old ttfb logic
                        ...
                        if (n > 0) {
                            ...
                            String rxHeaderLog =
                                    "========== [RX] TCP HEADER ==========\n"
                                            + "Source IP          : " + AppOpenTcpForwarder.ipStr(dstIp) + "\n"
                                            + "Destination IP     : " + AppOpenTcpForwarder.ipStr(srcIp) + "\n"
                                            + "Source Port        : " + dstPort + "\n"
